...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('career', '0001_initial'),
        ('exam', '0003_breakdown_exam_breakdown_exam_exammodule_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='exam',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Modulos'),
        ),
        migrations.AlterField(
